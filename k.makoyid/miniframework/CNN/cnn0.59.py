...
from lll import Visualizer
from lll.BatchNorm2d import BatchNorm2d
from lll.CNNData_loader import DataLoader
from lll.DataAugmentation import Compose, HorizontalFlip, RandomRotation
from lll.Filters import get_filters_for_layer
from lll.Layers import Conv2d, MaxPool2d, Dropout, Flatten, Linear
from lll.LossFunctions import CrossEntropyLoss
from lll.Optimizers import Adam
from lll.Visualizer import FilterVisualizer
...
#16x16
        self.conv2 = Conv2d(in_channels=23, out_channels=40, kernel_size=3, padding=1)
        self.bn2 = BatchNorm2d(40)
        ...
        self.fc1 = Linear(in_features=40 * 8 * 8, out_features=512)
    ...
    def backward(self, x, y):
        ...
        gradients = {
            'conv1_w': self.conv1.dW,
            'conv1_b': self.conv1.db,
            'conv2_w': self.conv2.dW,
...
if __name__ == "__main__":
    ...
    x_train, y_train, x_val, y_val, x_test, y_test = DataLoader.load_cifar10_data(total_images=20000)
